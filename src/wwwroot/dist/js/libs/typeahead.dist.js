import { c as commonjsGlobal } from "./commonjs.dist.js";
import { r as requireJquery } from "./jquery.dist.js";
var typeahead_bundleExports = {};
var typeahead_bundle = {
  get exports() {
    return typeahead_bundleExports;
  },
  set exports(v) {
    typeahead_bundleExports = v;
  }
};
/*!
 * typeahead.js 0.11.1
    ...
    (function() {
      ...
      methods = {
        initialize: function initialize(o, datasets) {
          ...
          function attach() {
            var $input, $wrapper, $hint, $menu, defaultHint, defaultMenu, eventBus, input, menu, typeahead2, MenuConstructor;
            ...
            $input.data(keys.typeahead, typeahead2);
          }
        },
        isEnabled: function isEnabled() {
          var enabled;
        ...
        destroy: function destroy() {
          ttEach(this, function(typeahead2, $input) {
            revert($input);
            typeahead2.destroy();
          });
          return this;
      ...
      function ttEach($els, fn) {
        $els.each(function() {
          var $input = $(this), typeahead2;
          (typeahead2 = $input.data(keys.typeahead)) && fn(typeahead2, $input);
        });
      }
...
const typeahead = typeahead_bundleExports;
export {
  typeahead as t
};
